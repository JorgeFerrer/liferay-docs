...
A module's Javadoc describes its Java API. It's available at
[https://docs.liferay.com/](https://docs.liferay.com/portal/7.0/javadocs/). 

Each module's Javadoc is also available for download as a JAR file from the
Liferay Portal CE [artifact repository]([https://repository.liferay.com/nexus/content/repositories/liferay-releases-ce/com/liferay/).
